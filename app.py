...
@app.route('/')
def root():
    # 🌟 MODIFICACIÓN: Redirige siempre a home. El acceso al home ya no está protegido.
    return redirect(url_for('home'))

@app.route('/home')
def home():
    # 🌟 MODIFICACIÓN: Permite el acceso sin sesión. La plantilla usará 'session'
    # para mostrar Iniciar Sesión/Cerrar Sesión según corresponda.
...
    return redirect(url_for('home')) # 🌟 Redirige a home tras logout
